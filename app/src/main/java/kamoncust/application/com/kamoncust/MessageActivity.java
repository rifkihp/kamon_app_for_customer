...
import kamoncust.application.com.adapter.MessageAdapter;
...
import kamoncust.application.com.model.message_list;
...
public class MessageActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(savedInstanceState==null) {
			no_trx = getIntent().getStringExtra("no_trx");
	...
	protected void onResume() {
		registerReceiver(mHandleLoadDataMessageReceiver,  new IntentFilter("kamoncust.application.com.kamoncust.LOAD_MESSAGE"));
		registerReceiver(mHandleNewMessageReceiver,  new IntentFilter("kamoncust.application.com.kamoncust.NEW_MESSAGE"));
		registerReceiver(mHandleSendMessageReceiver,  new IntentFilter("kamoncust.application.com.kamoncust.SEND_MESSAGE"));
	...
	public class loadDataMessage extends AsyncTask<String, Void, ArrayList<message>> {
	    ...
	    protected ArrayList<message> doInBackground(String... urls) {
			...
			if(security_code.length()>0) {
				...
				params.add(new BasicNameValuePair("no_trx", no_trx));
				...
				if(json!=null) {
					try {
						...
						for (int i=0; i<topics.length(); i++) {
							...
							Boolean is_self = !rec.isNull("is_self") && rec.getBoolean("is_self");
							Boolean is_sent = !rec.isNull("is_sent") && rec.getBoolean("is_sent");
						...
						if(produk!=null) {
							...
							//data_produk = new produk(id, kode, nama, id_category, category_name, penjelasan, foto1_produk, harga_beli, harga_jual, harga_diskon, persen_diskon, berat, list_ukuran, ukuran, list_warna, warna, qty, max_qty, minimum_pesan, dh.getIdWishlist(id)>0, produk_promo, produk_featured, produk_terbaru, produk_preorder, produk_soldout, produk_grosir, produk_freeongkir, rating, responden, review);
						}
	    ...
	    protected void onPostExecute(ArrayList<message> result) {
	    	...
	    	Intent i = new Intent("kamoncust.application.com.kamoncust.LOAD_MESSAGE");
	...
	class prosesAddKomentar extends AsyncTask<String, Void, JSONObject> {
		...
		protected void onPostExecute(JSONObject result) {
			...
			if(success) {
				Intent i = new Intent("kamoncust.application.com.kamoncust.SEND_MESSAGE");
