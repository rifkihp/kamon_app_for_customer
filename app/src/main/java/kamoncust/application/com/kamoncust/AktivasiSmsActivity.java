...
public class AktivasiSmsActivity extends AppCompatActivity {
    ...
    EditText kode_aktivasi;
    TextView proses_aktivasi;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aktivasi_sms);

        context = AktivasiSmsActivity.this;

        kode_aktivasi = (EditText) findViewById(R.id.edit_kode_aktivasi);
        proses_aktivasi = (TextView) findViewById(R.id.proses_aktivasi);

        proses_aktivasi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
            new prosesAktivasi().execute();
            }
        });
    ...
    class prosesAktivasi extends AsyncTask<String, Void, JSONObject> {
        ...
        protected void onPreExecute() {
            ...
            //progDailog.setMessage("Aktivasi...");
            //progDailog.show();
        }
        ...
        protected JSONObject doInBackground(String... urls) {
            ...
            if(security_code.length()>0) {
                try {
                    String url = CommonUtilities.SERVER_URL + "/store/androidProsesAktivasi.php";
                    HttpClient httpclient = new DefaultHttpClient();
                    HttpPost httppost = new HttpPost(url);

                    MultipartEntity reqEntity = new MultipartEntity();
                    reqEntity.addPart("no_hp", new StringBody(CommonUtilities.getNoHpAktivasi(context)));
                    reqEntity.addPart("kode_aktivasi", new StringBody(kode_aktivasi.getText().toString()));
