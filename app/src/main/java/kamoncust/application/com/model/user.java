...
public class user implements Serializable {
	...
	public user(int id, String username, String first_name, String last_name, String email, String phone, String dropship_name, String dropship_phone, String jenis_user, String photo, double saldo, int tipe) {
		this.id = id;
