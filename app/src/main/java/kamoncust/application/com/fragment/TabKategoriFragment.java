...
public class TabKategoriFragment extends Fragment {
    ...
    class loadDataProduk extends AsyncTask<String, Void, ArrayList<produk>> {
        ...
        protected ArrayList<produk> doInBackground(String... urls) {
            ...
            //params.add(new BasicNameValuePair("id", MainActivity.dashboard_produkgrup.get(index).getId()+""));
        ...
        protected void onPostExecute(ArrayList<produk> result) {
            ...
            //Toast.makeText(context, result.size()+" AAA", Toast.LENGTH_LONG).show();
