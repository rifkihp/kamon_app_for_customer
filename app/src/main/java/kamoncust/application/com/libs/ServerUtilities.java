...
import static kamoncust.application.com.libs.CommonUtilities.SERVER_URL;
import static kamoncust.application.com.libs.CommonUtilities.TAG;
...
public final class ServerUtilities {
    ...
    public static JSONObject register(final Context context, String regId, int user_id, int guest_id) {
        ...
        String url = SERVER_URL+ "/store/androidRegistrasiRegid.php";
