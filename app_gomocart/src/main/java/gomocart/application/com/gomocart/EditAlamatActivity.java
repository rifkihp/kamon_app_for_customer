...
public class EditAlamatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_address_gomocart);
    ...
    protected void onResume() {
        ...
        registerReceiver(mHandleProsesSaveAlamatReceiver, new IntentFilter("gomocart.application.com.gomocart.PROSES_SAVE_ALAMAT"));
        super.onResume();
    }
    ...
    public class prosesSave extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... urls) {
            ...
            Call<ResponseAlamatSave> saveAlamatCall = api.postSaveAlamat(
            ...
            saveAlamatCall.enqueue(new Callback<ResponseAlamatSave>() {
                @Override
                public void onResponse(@NonNull Call<ResponseAlamatSave> call, @NonNull Response<ResponseAlamatSave> response) {
                    ...
                    Intent i = new Intent("gomocart.application.com.gomocart.PROSES_SAVE_ALAMAT");
                ...
                @Override
                public void onFailure(@NonNull Call<ResponseAlamatSave> call, @NonNull Throwable t) {
