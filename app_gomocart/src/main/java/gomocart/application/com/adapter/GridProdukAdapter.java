...
public class GridProdukAdapter extends BaseAdapter {
    ...
    public GridProdukAdapter(Context context, DatabaseHandler dh, ArrayList<produk> produklist, int kode_grup) {
    ...
    public View getView(int position, View convertView, final ViewGroup parent) {
        ...
        final String url = (kode_grup==2?CommonUtilities.SERVER_URL+"/uploads/produk/":CommonUtilities.SERVER_URL+"/images/barang/")+prod.getFoto1_produk();
        if(size_image_square==0) {
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View convertView) {
                ...
                ((MainActivity) parent.getContext()).openDetailProduk(prod, kode_grup);
            }
        });
